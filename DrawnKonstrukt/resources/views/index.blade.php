...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin-top: 50px;">
            ...
            <h3 class="text-center text-danger"><b></b> </h3>
            <a href="/upload" class="btn btn-outline-success">Add New Post</a>
                ...
                <tbody>
                 ...
                 <tr>
                     <th scope="row">{{ $post->id }}</th>
                       ...
                       <td><a href="/share/{{ $post->id }}" class=" btn-outline-success">SEND</a></td>
                       <td>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">DRAWN KONSTRUKT</a>
        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><video class="float-end"  controls autoplay muted loop src="{{ asset('/videos/drawnv2.mp4') }}" height="auto" width="100%"></video></div>
                    <div class="col-lg-6">
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6">  <video class="img-fluid" controls autoplay muted loop src="{{asset('/videos/drawnv1.mp4') }}" width="500"></video></div>
                    <div class="col-lg-6 order-lg-first">
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">INTERIOS DESGIN</h4>
                                    <p class="mb-0 text-white-50">Drawn Konstrukt ...</p>
