                                    ...
                                    <div class="col-lg-6" style="background-color:green">
                                        ...
                                        <div class="form-group">
                                            <form action="/post" method="post" enctype="multipart/form-data">
                                             @csrf
                                             <input type="text" name="title" class="form-control m-2" placeholder="PROJECT NAME" required>
                                             <input type="text" name="author" class="form-control m-2" placeholder="PROJECT" required>
                                             <Textarea name="body" cols="20" rows="4" class="form-control m-2" placeholder="Project Description" required></Textarea>
                                             <label class="m-2">Overview Image</label>
                                             <input type="file" id="input-file-now-custom-3" class="form-control m-2" name="cover" required >
